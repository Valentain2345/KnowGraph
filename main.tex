...
\item \textit{Minimización de capas}: Se combinan comandos relacionados (ej: \texttt{apt-get update && apt-get install}) y se limpian cachés innecesarias para reducir el número de capas y el tamaño de la imagen.
\item \textit{Variables de entorno}: Se configuran variables para optimizar el entorno de ejecución de Python (\texttt{PYTHONUNBUFFERED, PYTHONDONTWRITEBYTECODE}).
